namespace Loupedeck.DevPilotPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.DevPilotPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.DevPilotPlugin.Resources.Resource.txt`.
